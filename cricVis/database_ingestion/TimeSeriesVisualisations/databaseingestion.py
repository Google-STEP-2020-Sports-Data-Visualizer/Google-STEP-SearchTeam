...
# To prevent any user without the private key from accessing the database
...
for table in batsman_tables:
    ...
    print("{table_name} dictionary successfully created...".format(table_name=table.table_name))
...
print("\nFinal json outputs of the database and its rules successfully created.\n")
